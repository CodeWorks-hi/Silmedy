...
public final class ItemMemberBinding implements ViewBinding {
  ...
  private ItemMemberBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageProfile,
  ...
  public static ItemMemberBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMemberBinding((LinearLayout) rootView, imageProfile, textName);
    }
